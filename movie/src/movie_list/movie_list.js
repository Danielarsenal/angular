(function (angular) {
    var app = angular.module("movie_list", ["ngRoute", "cross"]);
    ...
    app.controller("movie_listController", ["$scope", "$routeParams", "$window", "$route", "cross_jsonp", function ($scope, $routeParams, $window, $route, cross_jsonp) {
